...
const Slide = ({
    ...
    return (
        <div className="[perspective:1200px] [transform-style:preserve-3d]">
            <li
                ref={slideRef}
                className="flex flex-1 flex-col items-center justify-center relative text-center text-white opacity-100 transition-all duration-300 ease-in-out w-[70vmin] h-[70vmin] xl:w-[50vmin] xl:h-[50vmin] mx-[4vmin] z-10 "
...
export function Carousel({
    ...
    return (
        <div
            className="relative w-[70vmin] h-[70vmin] xl:w-[50vmin] xl:h-[50vmin] mx-auto"
